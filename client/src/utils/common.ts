...
export function targetValue<M = string, V = string>(callback: (value: M) => void, map?: (value: V) => M) {
  return (value: V) => {
...
export function inputValue<M = string>(callback: (value: M) => void, map?: (value: string) => M) {
